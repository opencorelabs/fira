...
func RegisterFiraServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FiraServiceServer) error {
	...
	mux.Handle("GET", pattern_FiraService_GetApiInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/protos.fira.v1.FiraService/GetApiInfo", runtime.WithHTTPPathPattern("/info"))
		if err != nil {
...
func RegisterFiraServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FiraServiceClient) error {
	...
	mux.Handle("GET", pattern_FiraService_GetApiInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/protos.fira.v1.FiraService/GetApiInfo", runtime.WithHTTPPathPattern("/info"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_FiraService_GetApiInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"info"}, ""))
)
